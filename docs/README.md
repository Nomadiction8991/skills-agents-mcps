...
- `skills/`: conjunto compartilhado de skills para `Codex`, `Claude` e `Copilot`.
- `agents/`: metadados publicados para alguns agents ligados as skills.
- `docs/`: documentacao operacional e changelog do repositorio.
